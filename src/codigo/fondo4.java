 ...
 * @author Manucho
 */
public class fondo4 extends JPanel{
    private Image imagenc = null;
    private MediaTracker tracker;
    
    public fondo4(Component componente){
        try {
            tracker = new MediaTracker(componente);
            Toolkit hr = Toolkit.getDefaultToolkit();
            imagenc = hr.getImage(getClass().getResource("/recursos/password.png"));
